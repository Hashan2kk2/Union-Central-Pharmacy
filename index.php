                                ...
                                <div class="hero__caption">
                                    ...
                                    <h1 class="cd-headline letters scale">We care about your
                                        <strong class="cd-words-wrapper">
                                            <b style="color: white !important;" class="is-visible">health</b>
                                            <b style="color: white !important;">Beauty</b>
                                            <b style="color: white !important;">Pets</b>
                                        </strong>
                                    </h1>
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="row align-items-center no-gutters">
                                <div class="col-lg-7">
                                    <div class="dept_info">
                                        <h3>Medicines</h3>
                                        <p>Medicines are substances that treat, prevent, or alleviate medical
                                            conditions. They interact with the body to promote healing and manage
                                            diseases. Available in various forms, they're used as directed by healthcare
                                            professionals for safe and effective results. </p>
                                        <!-- <a href="#" class="dep-btn">Appointment<i class="ti-arrow-right"></i></a> -->
                                    </div>
                                </div>
                                <div class="col-lg-5">
                                    <div class="dept_thumb">
                                        <img src="assets/img/gallery/medicine.png" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- single_content  -->
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="row align-items-center no-gutters">
                                <div class="col-lg-7">
                                    <div class="dept_info">
                                        <h3>Laboratory</h3>
                                        <p>Blood, urine, and other tests are diagnostic tools used to gather information
                                            about health. Blood tests analyze components like cells, proteins, and
                                            chemicals, providing insights into various conditions. Urine tests assess
                                            kidney function, infections, and overall well-being. These tests aid doctors
                                            in diagnosing and monitoring health, guiding proper treatment. </p>
                                        <!-- <a href="#" class="dep-btn">Appointment<i class="ti-arrow-right"></i></a> -->
                                    </div>
                                </div>
                                <div class="col-lg-5">
                                    <div class="dept_thumb">
                                        <img src="assets/img/gallery/lab.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- single_content  -->
                        ...
                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <div class="row align-items-center no-gutters">
                                <div class="col-lg-7">
                                    <div class="dept_info">
                                        <h3>Pets Care</h3>
                                        <p>Pet care involves maintaining the well-being of animals kept as companions.
                                            It includes proper feeding, regular exercise, grooming, and providing a safe
                                            environment. Additionally, administering medications and vaccines as needed
                                            ensures their health. Building strong bonds through attention and affection
                                            is vital for their happiness and overall quality of life. </p>
                                        <!-- <a href="#" class="dep-btn">Appointment<i class="ti-arrow-right"></i></a> -->
                                    </div>
                                </div>
                                <div class="col-lg-5">
                                    <div class="dept_thumb">
                                        <img src="assets/img/gallery/pets.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- single_content  -->
                        ...
                        <div class="tab-pane fade" id="Astrology" role="tabpanel" aria-labelledby="Astrology-tab">
                            ...
                            <div class="row align-items-center no-gutters">
                                <div class="col-lg-7">
                                    <div class="dept_info">
                                        <h3>Cosmetics</h3>
                                        <p>Cosmetics are products designed to enhance or alter appearance, applied to
                                            the body's external parts. They include makeup, skincare items, fragrances,
                                            and hair care products. Unlike drugs, cosmetics primarily aim to beautify
                                            rather than treat medical conditions. Always follow product instructions and
                                            consider patch testing for allergies. </p>
                                        <!-- <a href="#" class="dep-btn">Appointment<i class="ti-arrow-right"></i></a> -->
                                    </div>
                                </div>
                                <div class="col-lg-5">
                                    <div class="dept_thumb">
                                        <img src="assets/img/gallery/cosmetics.png" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- single_content  -->
