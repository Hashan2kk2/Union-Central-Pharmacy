            ...
            <div class="container">
                ...
                <div class="col-md-4 my-3 my-md-0 col-12">
                        <div style=" display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 20px;"
                            class=" btn">&nbsp; &nbsp;&nbsp;&nbsp; <a href="Union_Central_Seeduwa.php">Seeduwa</a></div>
                    </div>
                    <div class="col-md-4 my-3 my-md-0 col-12">
                        <div style=" display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 20px;"
                            class=" btn">&nbsp; &nbsp;&nbsp;&nbsp; <a href="Union_Central_Jaela.php">Ja Ela</a></div>
                    </div>
                    <div class="col-md-4 my-3 my-md-0 col-12">
                        <div style=" display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 20px;"
                            class=" btn">&nbsp; &nbsp;&nbsp;&nbsp; <a href="Union_Central_Katunayake.php">Katunayake</a></div>
                    </div>
                </div>
            </div>
        </div>
